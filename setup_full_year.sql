...
FROM
        `my-projects-397106.Cyclic_case_study.INFORMATION_SCHEMA.COLUMNS`
GROUP BY
        1;
...
SELECT 
	...
	end_lat, 
        ...
        quarter
FROM 
        `my-projects-397106.Cyclic_case_study.2021_Q3`
UNION DISTINCT  
SELECT 
        ride_id, 
        member_casual, 
	...
	end_lat, 
        ...
        quarter
FROM 
        `my-projects-397106.Cyclic_case_study.2021_Q4`
UNION DISTINCT  
SELECT 
        ride_id, 
        member_casual, 
	...
	end_lat, 
        ...
        quarter
FROM 
        `my-projects-397106.Cyclic_case_study.2022_Q1`
