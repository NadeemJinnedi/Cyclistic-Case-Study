...
UPDATE
  	`my-projects-397106.Cyclic_case_study.2021_02_biketrips`
SET
  	ride_length = '0:00:00'
WHERE
  	ride_length = '###############################################################################################################################################################################################################################################################' 
...
FROM 
 ...
 WITH biketrips_2021_02 AS 
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_03_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_04_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_05_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_06_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_07_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_08_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_09_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_10_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_11_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2021_12_biketrips`
        ...
        SELECT 
                ...
                COUNT (DISTINCT ride_id) AS ride_total
        FROM 
                `my-projects-397106.Cyclic_case_study.2022_01_biketrips`
...
SELECT 
	...
	'Q2' AS quarter
FROM 
        `my-projects-397106.Cyclic_case_study.2021_Q1`
